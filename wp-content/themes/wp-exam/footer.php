<div class="bgded overlay row4" style="background-image:url('<?php bloginfo('template_directory'); ?>/images/demo/backgrounds/01.png');">
    <footer id="footer" class="hoc clear">
        ...
        <div class="one_quarter">
            ...
            <ul class="nospace clear latestimg">
                <li><a class="imgover" href="#"><img src="<?php bloginfo('template_directory'); ?>/images/demo/100x100.png" alt=""></a></li>
                <li><a class="imgover" href="#"><img src="<?php bloginfo('template_directory'); ?>/images/demo/100x100.png" alt=""></a></li>
                <li><a class="imgover" href="#"><img src="<?php bloginfo('template_directory'); ?>/images/demo/100x100.png" alt=""></a></li>
                <li><a class="imgover" href="#"><img src="<?php bloginfo('template_directory'); ?>/images/demo/100x100.png" alt=""></a></li>
                <li><a class="imgover" href="#"><img src="<?php bloginfo('template_directory'); ?>/images/demo/100x100.png" alt=""></a></li>
...
<div class="wrapper row5">
    <div id="copyright" class="hoc clear">
        <!-- ################################################################################################ -->
        <p class="fl_left">Copyright &copy; 2018 - All Rights Reserved - <a href="#">Adavii.com</a></p>
